...
object BillingModule {
    ...
    fun provideBillingProvider(@ApplicationContext context: Context): BillingProvider {
        return object : BillingProvider {
            ...
            override val productIdMonthly: String = context.getString(com.msaitodev.passenger.opm.workpro.R.string.billing_product_id_premium)
            override val basePlanId: String = context.getString(com.msaitodev.passenger.opm.workpro.R.string.billing_base_plan_id)
            override val productIdLifetime: String = context.getString(com.msaitodev.passenger.opm.workpro.R.string.billing_product_id_lifetime)
